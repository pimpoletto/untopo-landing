...
const DOC: LegalDocId = "launch-phase";
const HREF = "/phase-lancement" as const;
const TITLE_KEY = "launchPhaseTitle" as const;
...
export default async function LaunchPhasePage({ params }: Props) {
  const { locale } = await params;
