  ...
  return (
    <div className="landing-page">
      <section className="landing-hero relative overflow-hidden">
        ...
        {/* Animation hero désactivée — réactiver avec <HeroLeakDetectionBg /> */}

        <Container className="relative z-[1] flex flex-col items-center px-4 pb-16 pt-16 text-center sm:pb-20 sm:pt-20 lg:pb-24 lg:pt-24">
